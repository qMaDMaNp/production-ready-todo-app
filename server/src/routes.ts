...
//TodoListItems
router.get('/todo-list-items/:todoListId', AuthMiddleware.isUser, TodoListItemController.show);
router.get('/todo-list-items/:todoListId/:id', AuthMiddleware.isUser, TodoListItemController.showOne);
